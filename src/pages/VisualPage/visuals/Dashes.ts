...
export default class Dashes extends Visual {
    ...
    public override draw(ctx: CanvasRenderingContext2D, options: DashOptions): void {
        ...
        this.timer = setInterval(() => {
            ...
            for (const dash of this.dashes) {
                ...
                for (const i in dash.previousPoints) {
                    ...
                    ctx.fillRect(dash.previousPoints[i].x, dash.previousPoints[i].y, dash.size, dash.size);
                }
